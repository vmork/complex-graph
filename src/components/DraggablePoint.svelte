<script lang="ts">
    ...
    canvasPos = {x: canvasPos.x - pointSizePx/2, y: canvasPos.y - pointSizePx/2};
    ...
    canvas.c.addEventListener("mouseup", (e) => { dragging = false; });
    canvas.c.addEventListener("mousemove", onDrag);
</script>

<div id="container"
    style="left: {canvasPos.x}px; top: {canvasPos.y}px;">
